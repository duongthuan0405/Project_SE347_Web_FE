...
import { participantManagementService } from '@/service/participantManagementService';
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Danh sách học viên có thể tham gia bài thi</p>
        </div>
        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>Nhập thông tin học viên để thêm vào danh sách</DialogDescription>
            </DialogHeader>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button type="submit" className="w-full">Thêm học viên</Button>
            </form>
          </DialogContent>
        </Dialog>
      </div>
        ...
        <CardHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription>Tổng số: {participants.length} học viên</CardDescription>
            </div>
          </div>
        </CardHeader>
